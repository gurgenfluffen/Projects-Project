...
private void deleteProject() {
	listProjects();
	Integer projectId = getIntInput("Select which project you wish to delete.");
	
	projectService.deleteProject(projectId);
	System.out.println("Project " + projectId + " was successfully deleted.");
	
	if(curProject.equals(projectId)) {
		curProject = null;
	}
}
...
private void updateProjectDetails() {
	...
	String projectName = getStringInput("Please enter the project name [" 
			+ curProject.getProjectName() + "]");
			
	BigDecimal estimatedHours = getDecimalInput("Enter the estimated hours required for this project ["
			+ curProject.getEstimatedHours() + "]");
	
	BigDecimal actualHours = getDecimalInput("Enter the actual hours required for this project [" 
	...
	project.setEstimatedHours(Objects.isNull(estimatedHours) ? 
			project.getEstimatedHours() : estimatedHours);
